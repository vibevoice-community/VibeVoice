"""
Data processing code for VibeVoice finetuning.

Adapted from https://github.com/voicepowered-ai/VibeVoice-finetuning/blob/main/src/data_vibevoice.py (MIT License)
"""
...
def _resample_if_needed(wav: np.ndarray, orig_sr: int, target_sr: int) -> np.ndarray:
    """
    Check if the audio needs to be resampled, if so, resample it.
    """
